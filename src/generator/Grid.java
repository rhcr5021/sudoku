...
public class Grid {
  ...
  public static Grid of(int[][] grid) {
    ...
    List<List<Cell>> boxes = new ArrayList<List<Cell>>();
    ...
    for (int i = 0; i < 9; i++) {
      ...
      for (Cell cell : row) {
        List<Cell> rowNeighbors = new ArrayList<Cell>(row);
      ...
      for (Cell cell : column) {
        List<Cell> columnNeighbors = new ArrayList<Cell>(column);
      ...
      for (Cell cell : box) {
        List<Cell> boxNeighbors = new ArrayList<Cell>(box);
